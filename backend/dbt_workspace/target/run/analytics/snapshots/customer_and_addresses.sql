      ...
      merge into "DevmySampleDatabase"."snapshots"."customer_and_addresses" as DBT_INTERNAL_DEST
    using "DevmySampleDatabase"."snapshots"."customer_and_addresses__dbt_tmp" as DBT_INTERNAL_SOURCE
